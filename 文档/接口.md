...
* 修改 **post** `v1/setting/commonBookMarkShow`

参数名                   |  类型    | 是否必要 | 说明              
------                  | ------   | ------  |------      
commonBookMarkShowState | int     | 是      | 控制常用书签是否显示，0：正常显示，1：隐藏，但鼠标覆盖显示，2：完全隐藏

### 侧边书签显示方式

* 修改 **post** `v1/setting/sideBookMarkShow`

参数名                   |  类型    | 是否必要 | 说明              
------                  | ------   | ------  |------      
sideBookMarkShowState   | int      | 是      | 控制侧边书签显示方式，0：隐藏，1：仅显示图标，2：仅显示入口
sideBookMarkPosition    | int      | 是      | 侧边书签位置，0,1,2,3 上右下左
